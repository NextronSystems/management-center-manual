...
.. list-table::
    ...
    * - Bugfix
      - Fixed Management Center 4.0 showing as compatible on Master Management Center 3.3
    * - Bugfix
      - Fixed major upgrade page showing for Management Centers not eligible for upgrade
...
.. list-table::
    ...
    * - Type
      - Description
    * - Feature
      - Preparation for upcoming Management Center 4.0 release
    * - Security
    ...
    * - Bugfix
      - Fixed an issue where the Endpoint Agent could crash on startup on AIX 7300-04 due to incompatibility with the LLU feature newly introduced by AIX
