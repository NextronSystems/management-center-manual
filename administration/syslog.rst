...
.. list-table::
   ...
   * - 1
     - Server
     - The receiving server. ``%asgard-host%`` is the Management Center that issued the scan for the Agent
...
to forward your logs via the Management Center to a SIEM, see
