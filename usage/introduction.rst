...
Management Center is the central management platform for THOR scans.
It manages distributed THOR scans on thousands of systems, collects and
forwards scan results. 

Furthermore, the Management Center can control and execute complex response
tasks, if needed.
...
Moreover, the Management Center provides an easy to use interface for
creation of custom
multi-step response playbooks that can execute any command on endpoints
and collect the respective outputs. 

Management Center is available as a virtual appliance and also as a
...
the Management Center. It will describe how to add systems to be
